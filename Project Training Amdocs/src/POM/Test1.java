	...
	public class Test1 {
		...
		public static void main(String[] args) {
			...
			System.setProperty("webdriver.gecko.driver",
					"C:\\Users\\admin\\Downloads\\geckodriver-v0.34.0-win64\\geckodriver.exe");
			...
			try {
				...
				formPage.setFirstName("N");
				formPage.setLastName("Mahant");
				formPage.setEmail("mahant@gmail.com");
				formPage.selectGender();
				formPage.setUserNumber("7710279071");
				formPage.setDateOfBirth("March", "2003", "24");
				formPage.setSubjects("Computer Science");
				formPage.selectHobbies();
				formPage.uploadPicture("C:\\Users\\admin\\Downloads\\8th Sem.jpg");
